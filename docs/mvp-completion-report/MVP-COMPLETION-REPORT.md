...
- 最新 10 笔用户交易，显示交易哈希、类型、时间、发送方、状态
...
- **日期范围筛选** — 快捷选项及自定义日期
- **发送方地址筛选** — 按指定地址过滤
- **代币类型筛选** — 可用于代币转账记录（MOVE、USDC、USDT 等）
- **活动类型筛选** — 可用于 NFT 转账记录（铸造、转账、销毁等）
